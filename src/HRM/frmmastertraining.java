...
public class frmmastertraining extends javax.swing.JFrame {
DbConnection DbConn = new DbConnection();
boolean add,edit;
    public frmmastertraining() {
        initComponents();
        DbConn.DoConnect();
        FillTable();
    ...
    private void FillTable(){
        try{
            DbConn.pstmt = DbConn.conn.prepareStatement("Select tt_seqno,tt_description from tblmastertrainingtype order by tt_description");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HR -> Training Type");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (add==true && edit==false){
            try{
                DbConn.SQLQuery = "insert into tblmastertrainingtype (tt_description,tt_addby,tt_date) values(?,?,?)";
...
//                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
        ...
        int ba = tableMaster.convertRowIndexToModel(row);
                try{
                    DbConn.SQLQuery = "update tblmastertrainingtype set tt_description=?,tt_addby=?,tt_date=? where tt_seqno=?";
                    DbConn.pstmt = DbConn.conn.prepareStatement(DbConn.SQLQuery);
                    DbConn.pstmt.setString(1, txtDescription.getText());
    //                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
                    DbConn.pstmt.setString(2, "Admin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmastertraining.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmastertraining().setVisible(true);
            }
        });
    }
