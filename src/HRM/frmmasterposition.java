...
public class frmmasterposition extends javax.swing.JFrame {
...
boolean add,edit;
    ...
    private void FillTable(){
        try{
            DbConn.pstmt = DbConn.conn.prepareStatement("Select po_seqno,po_description from tblposition order by po_description");
            ...
            JOptionPane.showMessageDialog(this, "Position Fill Table");
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HR Position Master");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (add==true && edit==false){
            try{
                DbConn.SQLQuery = "insert into tblposition (po_description,po_addby,po_date) values(?,?,?)";
...
//                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
                ...
                JOptionPane.showMessageDialog(this, "HR Position");
            }
        }else{
        ...
        int ba = tableMaster.convertRowIndexToModel(row);
                try{
                    DbConn.SQLQuery = "update tblposition set po_description=?,po_addby=?,po_date=? where po_seqno=?";
                    DbConn.pstmt = DbConn.conn.prepareStatement(DbConn.SQLQuery);
                    DbConn.pstmt.setString(1, txtDescription.getText());
    //                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
                    DbConn.pstmt.setString(2, "Admin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmasterposition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmasterposition().setVisible(true);
            }
        });
    }
