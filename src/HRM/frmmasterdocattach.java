...
public class frmmasterdocattach extends javax.swing.JFrame {
DbConnection DbConn = new DbConnection();
boolean add,edit;
    public frmmasterdocattach() {
        initComponents();
        DbConn.DoConnect();
        FillTable();
    ...
    private void FillTable(){
        try{
            DbConn.pstmt = DbConn.conn.prepareStatement("Select do_seqno,do_description from tblmasterdocattach order by do_description");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HR -> Document Type");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (add==true && edit==false){
            try{
                DbConn.SQLQuery = "insert into tblmasterdocattach (do_description,do_addby,do_date) values(?,?,?)";
...
//                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
        ...
        int ba = tableMaster.convertRowIndexToModel(row);
                try{
                    DbConn.SQLQuery = "update tblmasterdocattach set do_description=?,do_addby=?,do_date=? where do_seqno=?";
                    DbConn.pstmt = DbConn.conn.prepareStatement(DbConn.SQLQuery);
                    DbConn.pstmt.setString(1, txtDescription.getText());
    //                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
                    DbConn.pstmt.setString(2, "Admin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmasterdocattach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmasterdocattach().setVisible(true);
            }
        });
    }
