...
public class frmmastercvsource extends javax.swing.JFrame {
DbConnection DbConn = new DbConnection();
boolean add,edit;
    public frmmastercvsource() {
        initComponents();
        DbConn.DoConnect();
        FillTable();
    ...
    private void FillTable(){
        try{
            DbConn.pstmt = DbConn.conn.prepareStatement("Select cs_seqno,cs_description from tblcvsource order by cs_description");
            ...
            JOptionPane.showMessageDialog(this, "CV Source Fill Table");
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CV Source Master");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (add==true && edit==false){
            try{
                DbConn.SQLQuery = "insert into tblcvsource (cs_description,cs_addby,cs_date) values(?,?,?)";
...
//                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
                ...
                JOptionPane.showMessageDialog(this, "CV source Save");
            }
        }else{
            if (add==false && edit==true){
                ...
                int ba = tableMaster.convertRowIndexToModel(row);
                try{
                    DbConn.SQLQuery = "update tblcvsource set cs_description=?,cs_addby=?,cs_date=? where cs_seqno=?";
                    DbConn.pstmt = DbConn.conn.prepareStatement(DbConn.SQLQuery);
                    DbConn.pstmt.setString(1, txtDescription.getText());
    //                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
                    DbConn.pstmt.setString(2, "Admin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmastercvsource.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmastercvsource().setVisible(true);
            }
        });
    }
