...
public class frmmasterdesignation extends javax.swing.JFrame {
DbConnection DbConn = new DbConnection();
boolean add,edit;
    public frmmasterdesignation() {
        initComponents();
        DbConn.DoConnect();
        FillTable();
    ...
    private void FillTable(){
        try{
            DbConn.pstmt = DbConn.conn.prepareStatement("Select de_seqno,de_description from tbldesignation order by de_description");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HR -> Designation");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (add==true && edit==false){
            try{
                DbConn.SQLQuery = "insert into tbldesignation (de_description,de_addby,de_date) values(?,?,?)";
...
//                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
        ...
        int ba = tableMaster.convertRowIndexToModel(row);
                try{
                    DbConn.SQLQuery = "update tbldesignation set de_description=?,de_addby=?,de_date=? where de_seqno=?";
                    DbConn.pstmt = DbConn.conn.prepareStatement(DbConn.SQLQuery);
                    DbConn.pstmt.setString(1, txtDescription.getText());
    //                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
                    DbConn.pstmt.setString(2, "Admin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmasterdesignation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmasterdesignation().setVisible(true);
            }
        });
    }
