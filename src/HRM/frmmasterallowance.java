...
public class frmmasterallowance extends javax.swing.JFrame {
DbConnection DbConn = new DbConnection();
boolean add,edit;
    public frmmasterallowance() {
        initComponents();
        DbConn.DoConnect();
        FillTable();
    ...
    private void FillTable(){
        try{
            DbConn.pstmt = DbConn.conn.prepareStatement("Select al_seqno,al_description from tblmasterallowance order by al_description");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (add==true && edit==false){
            try{
                DbConn.SQLQuery = "insert into tblmasterallowance (al_description,al_addby,al_date) values(?,?,?)";
...
//                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
        ...
        int ba = tableMaster.convertRowIndexToModel(row);
                try{
                    DbConn.SQLQuery = "update tblmasterallowance set al_description=?,al_addby=?,al_date=? where al_seqno=?";
                    DbConn.pstmt = DbConn.conn.prepareStatement(DbConn.SQLQuery);
                    DbConn.pstmt.setString(1, txtDescription.getText());
    //                DbConn.pstmt.setString(2, DbConn.GetLoggedInUserName);
                    DbConn.pstmt.setString(2, "Admin");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmasterallowance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmasterallowance().setVisible(true);
            }
        });
    }
